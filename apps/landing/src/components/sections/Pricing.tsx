...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Page client multilingue (FR / EN / Malagasy)',
      'QR codes de table designés (avec logo au centre)',
      'Reçus thermiques personnalisés (logo, slogan, mentions légales)',
      'Mode borne client (tablette en libre-service à table)',
    ],
    cta: 'Choisir Pro+',
